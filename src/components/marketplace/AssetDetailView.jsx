                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-white font-normal">{parseInt(asset.totalFractions).toLocaleString()}</p>
                    </div>
                    <div>
            ...
            <div className="sticky top-8 bg-black border border-neutral-900 rounded-sm">
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-white">{asset.pricePerFraction} OPN</p>
                </div>
