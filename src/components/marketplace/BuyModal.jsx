        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-[140px,1fr] gap-6 mb-8">
            ...
            <div>
              ...
              <h3 className="text-xl font-light text-white mb-3">{asset.assetName}</h3>
            ...
            <div className="bg-neutral-950 border border-neutral-900 p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-light text-white">{formatPercentage(percentage)}%</span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-base font-light text-white">Total Cost</span>
