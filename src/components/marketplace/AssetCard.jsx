  ...
  return (
    <div className="group relative bg-black border border-neutral-900 rounded-sm overflow-hidden transition-all duration-500 hover:border-neutral-800">
      ...
      <div className="p-6">
        ...
        {/* Location/Description - Keep font-light for secondary text */}
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <p className="text-sm font-normal text-white">{formatNumber(asset.pricePerFraction)} OPN</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm font-normal text-white">{formatNumber(asset.availableFractions)} / {formatNumber(asset.totalFractions)}</p>
          </div>
          <div>
        ...
        {/* Action Button - Changed to font-normal */}
        <button
