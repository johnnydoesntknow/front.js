    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-400 font-light">Connect your wallet to view your portfolio</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-baseline gap-4 mb-4">
                ...
                <span className="text-lg font-light text-neutral-400">OPN</span>
              </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <span className="text-neutral-500 font-light">All Time</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs font-light text-neutral-500 mb-1">24h Change</p>
                <p className={`text-lg font-light ${performance.daily >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {performance.daily >= 0 ? '+' : ''}{performance.daily}%
                </p>
              </div>
              <div>
                <p className="text-xs font-light text-neutral-500 mb-1">7d Change</p>
                <p className={`text-lg font-light ${performance.weekly >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {performance.weekly >= 0 ? '+' : ''}{performance.weekly}%
                </p>
              </div>
              <div>
                <p className="text-xs font-light text-neutral-500 mb-1">30d Change</p>
                <p className={`text-lg font-light ${performance.monthly >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {performance.monthly >= 0 ? '+' : ''}{performance.monthly}%
                </p>
              </div>
              <div>
                <p className="text-xs font-light text-neutral-500 mb-1">All Time</p>
                <p className={`text-lg font-light ${performance.allTime >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <div className="grid grid-cols-4 gap-[1px] bg-neutral-900 mb-12">
          <div className="bg-black p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-xs font-light uppercase tracking-widest text-neutral-500">
                Assets Owned
              </p>
            </div>
            <p className="text-2xl font-light text-white">{totalAssets}</p>
          </div>
          ...
          <div className="bg-black p-6">
            ...
            <p className={`text-2xl font-light ${totalGain >= 0 ? 'text-green-400' : 'text-red-400'}`}>
          ...
          <nav className="flex">
            {tabs.map((tab) => (
              <button
                ...
                className={`
                  px-6 py-4 text-sm font-light transition-all duration-300 border-b-2
                  ${activeTab === tab.id 
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-black border border-neutral-900 p-6">
              <h3 className="text-lg font-light text-white mb-6">Asset Allocation</h3>
                  ...
                  return (
                    <div key={type}>
                      <div className="flex justify-between mb-2">
                        <span className="text-sm font-light text-neutral-300">{type}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {userAssets.length === 0 ? (
              <div className="col-span-full text-center py-32">
                ...
                <p className="text-neutral-500 font-light text-lg">No assets in portfolio</p>
              ...
              userAssets.map((asset) => (
                <div key={asset.tokenId} className="bg-black border border-neutral-900 overflow-hidden group hover:border-neutral-800 transition-all duration-500">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-light text-white mb-1">{asset.assetName}</h3>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg font-light text-white">{asset.percentageOwned.toFixed(3)}%</span>
                      </div>
                    ...
                    <div className="space-y-2 pt-4 border-t border-neutral-900">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-white font-light">{formatNumber(asset.totalValue)} OPN</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-neutral-500 font-light">Purchase Value</span>
                        <span className="text-neutral-400 font-light">{formatNumber(asset.purchaseValue)} OPN</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-neutral-500 font-light">Gain/Loss</span>
                        <span className={`font-light ${asset.gain >= 0 ? 'text-green-400' : 'text-red-400'}`}>
          ...
          <div className="space-y-4">
            {userRequests.length === 0 ? (
              <div className="text-center py-32">
                ...
                <p className="text-neutral-500 font-light text-lg">No fractionalization requests</p>
                <p className="text-neutral-600 font-light text-sm mt-2">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <h3 className="text-lg font-light text-white mb-1">{request.assetName}</h3>
                        ...
                        <div className="flex items-center gap-3">
                          {request.requiresPurchaserKYC && (
                            <div className="flex items-center gap-1 px-2 py-1 bg-amber-900/20 border border-amber-900/50 rounded-sm">
                              ...
                              <span className="text-xs text-amber-400">KYC Required</span>
                            </div>
                          )}
                          <span className={`
                            px-3 py-1 text-xs font-light uppercase tracking-wider rounded-sm
                      ...
                      <div className="grid grid-cols-4 gap-6 mt-6">
                        <div>
                          ...
                          <p className="text-white font-light">{parseInt(request.totalFractions).toLocaleString()}</p>
                        </div>
                        <div>
                          <p className="text-xs font-light text-neutral-500">Price/Fraction</p>
                          <p className="text-white font-light">{request.pricePerFraction} OPN</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="text-white font-light">{request.timestamp}</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        {activeTab === 'analytics' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-black border border-neutral-900 p-6">
              <h3 className="text-lg font-light text-white mb-6">Portfolio Performance</h3>
            ...
            {/* Top Holdings */}
            <div className="bg-black border border-neutral-900 p-6">
              <h3 className="text-lg font-light text-white mb-6">Top Holdings by Value</h3>
              <div className="space-y-4">
                {userAssets
                  ...
                  .map((asset, index) => (
                    <div key={asset.tokenId} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-light text-white">{asset.assetName}</p>
                          <p className="text-xs font-light text-neutral-500">{asset.percentageOwned.toFixed(3)}% owned</p>
                        </div>
                      </div>
                      <p className="text-sm font-light text-white">{formatNumber(asset.totalValue)} OPN</p>
                    </div>
                  ))}
              </div>
            </div>
