          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className={`text-lg font-normal ${performance.daily >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {performance.daily >= 0 ? '+' : ''}{performance.daily}%
                </p>
              </div>
              <div>
                <p className="text-xs font-light text-neutral-500 mb-1">7d Change</p>
                <p className={`text-lg font-normal ${performance.weekly >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {performance.weekly >= 0 ? '+' : ''}{performance.weekly}%
                </p>
              </div>
              <div>
                <p className="text-xs font-light text-neutral-500 mb-1">30d Change</p>
                <p className={`text-lg font-normal ${performance.monthly >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {performance.monthly >= 0 ? '+' : ''}{performance.monthly}%
                </p>
              </div>
              <div>
                <p className="text-xs font-light text-neutral-500 mb-1">All Time</p>
                <p className={`text-lg font-normal ${performance.allTime >= 0 ? 'text-green-400' : 'text-red-400'}`}>
