          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {/* Complete Property Features - ALL FIELDS */}
                <div className="grid grid-cols-2 gap-4 p-4 bg-neutral-950 rounded-sm">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        {property.location || property.propertyLocation || 'Location not specified'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        {property.size || property.propertySize || 'Size not specified'}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Property Type */}
                  <div className="flex items-center space-x-3">
                    <PropertyTypeIcon className="w-5 h-5 text-neutral-500" />
                    <div>
                      <p className="text-xs text-neutral-500">Type</p>
                      <p className="text-white">
                        {property.propertyType || property.propertySubType || 'Residential'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        {property.yearBuilt || property.propertyYear || 'Year not specified'}
                      </p>
                    </div>
                  </div>
                  ...
                  {property.vehicleMake && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">
                          {property.vehicleYear} {property.vehicleMake} {property.vehicleModel}
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {property.vehicleVIN && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">{property.vehicleVIN}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {property.artistName && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">{property.artistName}</p>
                      </div>
                    </div>
                  )}
                  
                  {property.artworkYear && (
                    <div className="flex items-center space-x-3">
                      <Calendar className="w-5 h-5 text-neutral-500" />
                      <div>
                        <p className="text-xs text-neutral-500">Year Created</p>
                        <p className="text-white">{property.artworkYear}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {property.brand && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">{property.brand}</p>
                      </div>
                    </div>
                  )}
                  
                  {property.collectionYear && (
                    <div className="flex items-center space-x-3">
                      <Calendar className="w-5 h-5 text-neutral-500" />
                      <div>
                        <p className="text-xs text-neutral-500">Collection Year</p>
                        <p className="text-white">{property.collectionYear}</p>
                      </div>
                    </div>
                  )}
                </div>
