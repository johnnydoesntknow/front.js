...
const PropertyModal = ({ property, onClose }) => {
  ...
  const totalCost = (parseFloat(property.pricePerShare) * amount).toFixed(4);
  const maxAmount = parseInt(property.availableShares);
  ...
  const handlePurchase = async () => {
    try {
      setLoading(true);
      await purchaseShares(property.assetId, amount);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
            ...
            <div>
              ...
              <div className="p-6 bg-neutral-950 rounded-sm mb-6">
                <h4 className="text-lg font-semibold text-white mb-4">Investment Overview</h4>
                
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-neutral-400 font-light">Total Property Value</span>
                    <span className="text-white font-normal">{totalValue.toFixed(2)} OPN</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="p-6 border border-neutral-800 rounded-sm">
                <h4 className="text-lg font-normal text-white mb-4">Purchase Shares</h4>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="label-text block mb-2">NUMBER OF SHARES</label>
