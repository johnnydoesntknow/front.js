...
const PropertyModal = ({ property, onClose }) => {
  ...
  useEffect(() => {
    const fetchUserShares = async () => {
      if (address && property) {
        try {
          ...
          const shares = await getUserShares(address, property.assetId || property.tokenId);
    ...
    fetchUserShares();
  }, [address, property, getUserShares]);
        ...
        <div className="overflow-y-auto flex-1">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
            ...
            <div className="space-y-6">
              ...
              {maxPurchaseAmount > 0 && (
                <div className="bg-neutral-900 border border-neutral-800 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-white mb-2">Purchase Limits</p>
              ...
              {/* Purchase Interface - Only show if user hasn't reached limit */}
              {!hasReachedLimit ? (
                    ...
                    <div>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex justify-between mt-2">
                          ...
                          <span className="text-xs text-neutral-500">{formatPercentage(maxPercentage)}%</span>
                        </div>
                      </div>
