...
const PropertyDetailView = ({ property, onBack }) => {
  ...
  const renderAssetInformation = () => {
        ...
        <div className="bg-neutral-950 border border-neutral-800 p-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-white">Vehicle</p>
            </div>
            <div>
    ...
    // Real Estate Information (default for properties)
    ...
    <>
      <div className="min-h-screen bg-black">
        ...
        <div className="relative h-[40vh] sm:h-[50vh] bg-neutral-950 overflow-hidden">
          ...
          <button
            onClick={onBack}
            className="absolute top-6 left-6 p-3 bg-black/50 backdrop-blur-sm hover:bg-black/70 transition-colors"
          >
