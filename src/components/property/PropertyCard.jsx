...
const PropertyCard = ({ property, onViewDetails }) => {
  const availablePercentage = (parseInt(property.availableFractions) / parseInt(property.totalFractions)) * 100;
  ...
  return (
    <div className="card-hover group cursor-pointer" onClick={() => onViewDetails(property)}>
      {/* Image - Added relative positioning */}
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 py-4 border-y border-neutral-900">
          <div>
            ...
            <p className="text-white font-light">{property.pricePerFraction} OPN</p>
          </div>
          <div>
        ...
        <div className="mt-4">
          <div className="flex justify-between text-sm mb-2">
            ...
            <span className="text-white">
              {property.availableFractions}/{property.totalFractions} fractions
            </span>
          </div>
