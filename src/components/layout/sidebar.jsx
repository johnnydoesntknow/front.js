    ...
    `}>
      ...
      <div className={`p-6 border-b border-neutral-900 ${isCollapsed ? 'px-2' : ''}`}>
        <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'}`}>
          <div className="w-10 h-10 bg-gradient-to-br from-neutral-800 to-neutral-900 
                          border border-neutral-700 flex items-center justify-center">
            <span className="text-white font-bold text-lg">O</span>
          </div>
          {!isCollapsed && (
            <div>
              <h1 className="text-white font-medium text-lg tracking-tight">OPN</h1>
  ...
  {!isConnected ? (
    ...
    <button
      ...
      className="w-full px-3 py-3 bg-neutral-900 text-white border-l-2 border-white
                 transition-all duration-200 hover:bg-neutral-800 text-center"
    >
      Connect Wallet
    </button>
  ) : (
    ...
    <div className="relative">
        ...
        {isCollapsed ? (
          ...
          <div className="flex justify-center">
            <div className="text-center">
              ...
              <p className="text-xs text-white opacity-70">OPN</p>
            </div>
          </div>
        ) : (
          // Expanded view - centered and bigger
          <div className="text-center">
      ...
      {/* Wallet Menu Dropdown - COMPLETE CODE */}
