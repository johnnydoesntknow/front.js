  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="max-w-4xl mx-auto px-4 py-12">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-3xl font-light text-white mb-3">Asset Tokenization</h1>
          <p className="text-neutral-400 font-light">Transform real-world assets into tradeable fractional ownership</p>
        </div>
